        ...
        return (
                <section>
                        <div className={`container ${teamStyles.teamOverview}`}>
                                <div className={teamStyles.teamTitle} data-aos="zoom-in">
                                ...
                                <div className='row'>
                                        <div className="tab-item-wrapper">
                                                <div className='d-flex flex-wrap justify-content-between py-5'>
                                                        <div className={`p-4 text-center ${teamStyles.containBlock} ${teamStyles.animate}`}>
                                                                <div data-aos="fade-down-right">
                                                                        <img className={`mb-2 ${teamStyles.containBlockImg}`} src="img/industries/classroom.svg" />
